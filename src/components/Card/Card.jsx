    ...
    return (
        <div className={`${css.card} ${css[variant]}`}>
            <div className={css.svgContainerTop}>
                ...
                </svg>         <h3 className={`${css.cardTitle} ${variant === 'variant3' ? css.variant3Text : ''}`}>{title}</h3>
      </div>
      <p className={`${css.cardContent} ${variant === 'variant3' ? css.variant3Text : ''}`}>{content}</p>
      <div className={css.svgContainerBottom}>
        <p className={`${css.cardTagline} ${variant === 'variant3' ? css.variant3Text : ''}`}>{tagline}</p>  <svg className={css.icon}>
